            ...
            <div class="container">
                <div class="row">                    
                        ...
                        <div class="footer-col-inner">
                          <ul class="list-unstyled">
                              <li><a href="about.php"><i class="fa fa-caret-right"></i>About us</a></li>
                                ...
                                <li><a href="faqs.php"><i class="fa fa-caret-right"></i>FAQs</a></li>
                            </ul>
                    ...
                    <div class="footer-col links col-md-2 col-sm-4 col-xs-12">
                        <div class="footer-col-inner">
                          <ul class="list-unstyled">
                            <li><a href="features.php"><i class="fa fa-caret-right"></i>How it works?</a></li>
                    ...
                    <div class="footer-col connect col-md-6 col-sm-12 col-xs-12">
                        <div class="footer-col-inner">
                            ...
                            <div class="form-container">
                                <p class="intro">Stay up to date with the latest news and offers from Cold Calling</p>
                ...
                <div class="row has-divider"><!--//download--><!--//contact-->
                </div>
            </div><!--//container-->
        </div><!--//footer-content-->
        <div class="bottom-bar">
            <div class="container">
                <small class="copyright">Copyright &copy; 2015 <a href="#" target="_blank">Cold Calling Team</a></small>                
            </div><!--//container-->
        </div><!--//bottom-bar-->
    </footer>