 ...
 <div class="navbar-header">
               ...
               <h1> <a class="navbar-brand" href="view_task.php">Cold Calling</a></h1>         
			   </div>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
		    <div class="drop-men" >
		        <ul class=" nav_1">
					...
					<li class="dropdown">
		              <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret"><?php echo "Welcome ".$_SESSION['fname'];?><i class="caret"></i></span><img src="images/wo.jpg"></a>
